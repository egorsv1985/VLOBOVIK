...
$MESS["REQUEST"] = "Оставьте заявку";
$MESS["HELP"] = "получите консультацию";
$MESS["GRATIS"] = "бесплатно";
$MESS["GET"] = "Получить";
$MESS["PHONE"] = "Наш менеджер перезвонит Вам.";
$MESS["QUESTIONS"] = "ОСТАЛИСЬ ВОПРОСЫ?";
$MESS["ANSWERS"] = "С РАДОСТЬЮ ОТВЕТИМ!";
$MESS["FORM"] = "Заполнение заявки вас ни к чему не обязывает. Ваши данные не будут
